    ...
    return (
      <nav className="bg-[#FFD476] w-full lg:h-[10vh] sm:h-[10vh] flex items-center px-6 relative z-20">
        ...
        <div className="flex ml-auto gap-4 sm:gap-8">
          {buttonText && (
            <button
              className={`text-white outline-2 outline-[#F25019] font-[500] text-[0.9rem] sm:text-[1rem] text-medium bg-[#F25019] px-4 py-2 sm:px-5 sm:py-3 rounded-[10] hover:bg-[#C93E0F]  active:bg-[#C93E0F] cursor-pointer transition-colors duration-400 ease-in-out ${inter.className}`}
              onClick={ButtonClick}
            >
              {buttonText}
            </button>
